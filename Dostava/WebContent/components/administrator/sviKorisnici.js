    ...
    upper: function(value) {
      ...
      <div>
        ...
        <div class="bottom ">
            ...
            <div class="row">
                <div style="margin: 20px;" v-for="k in pronadjeniKorisnici">
                    <div class="card">
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item">
                          <b>{{k.imePrezime}}</b>    
                          <button v-if="uloga==='ADMINISTRATOR' && k.uloga !== 'Administrator'" class="btn btn-info btn-sm" style="float: right;" @click="obrisiKorisnika(k.id)">Obriši korisnika</button>
